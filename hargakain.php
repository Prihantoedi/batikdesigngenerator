...
<head>
    ...
    <title>Harga Kain - Batik Web App</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-5 text-gray-800">Kelola Harga Kain (Per m <sup>2</sup>)</h1>
                    <form method="post" action="processhargakain.php?id=1">
                        ...
                        <div class="form-group w-25">
                            ...
                            <input type="number" step = 0.01 class="form-control" id="exampleInputPassword1"  name="hargaBaru" placeholder="Masukkan Harga Baru" required>
                        </div>
