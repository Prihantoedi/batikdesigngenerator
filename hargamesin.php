<?php
    ...
    if (isset($_SESSION['harga_new'])) {
        unset($_SESSION['harga_new']);
    }

    if (isset($_SESSION['harga_old'])) {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-5 text-gray-800">Kelola Harga Mesin</h1>

                    <!-- Member Baru -->
                    <h2 class="h5">Harga Member Baru</h2>

                    <form method="post" action="processhargamesin.php?id=1">
                        <div class="form-group w-25">
                            <label for="exampleInputEmail1">Harga Lama</label>
                            <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $_SESSION['harga_new']?>" readonly>
                    ...
                    <!-- Member Lama -->
                    <h2 class="h5 mt-5">Harga Member Lama</h2>

                    <form method="post" action="processhargamesin.php?id=2">
                        <div class="form-group w-25">
                            <label for="exampleInputEmail1">Harga Lama</label>
                            <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $_SESSION['harga_old']?>" readonly>
                            <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                        </div>
                        <div class="form-group w-25">
                            <label for="exampleInputPassword1">Harga Baru</label>
