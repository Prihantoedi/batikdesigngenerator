<?php
    ...
    if (isset($_SESSION['harga_celup'])) {
        unset($_SESSION['harga_celup']);
    }

    if (isset($_SESSION['harga_colet'])) {
            ...
            <li class="nav-item">
                ...
                <div id="collapseHarga" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="hargateknik.php">Harga Teknik</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-5 text-gray-800">Kelola Harga Teknik</h1>

                    <!-- Member Baru -->
                    <h2 class="h5">Harga Teknik Celup</h2>

                    <form method="post" action="processhargateknik.php?id=1">
                        <div class="form-group w-25">
                            <label for="exampleInputEmail1">Harga Lama</label>
                            <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $_SESSION['harga_celup']?>" readonly>
                    ...
                    <!-- Member Lama -->
                    <h2 class="h5 mt-5">Harga Teknik Colet</h2>

                    <form method="post" action="processhargateknik.php?id=2">
                        <div class="form-group w-25">
                            <label for="exampleInputEmail1">Harga Lama</label>
                            <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $_SESSION['harga_colet']?>" readonly>
                            <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                        </div>
                        <div class="form-group w-25">
                            <label for="exampleInputPassword1">Harga Baru</label>
